...
Truth_states_final_flu$as_of <- 20240510
  ...
  Truth_states_prelim_flu$as_of <- 20240508
  ...
  Prior_week_prelim_flu$as_of <- 20240501
  ...
  Prior_week_final_flu$as_of <- 20240503
...
pdf(file = "/Users/mkerr/Documents/hospitalizations/5_10_flu hospitalizations_map.pdf", height = 24, width = 16)
#pdf(file = "/Users/mkerr/Documents/hospitalizations/5_03_flu hospitalizations_map.pdf", height = 10, width = 20)
flu_plot <- ggplot(data = New_dataset_flu, aes(x = date, y = inc, color = as_of, group = as_of)) +
    ...
    facet_wrap_paginate(~location_name, ncol = 8, nrow = 12, scales = "free")
...
#add diff as of dates
  ...
  Truth_states_prelim_flu$as_of <- 20240424
  ...
  Prior_week_prelim_flu$as_of <- 20240417
  ...
  Prior_week_final_flu$as_of <- 20240419
...
my_colors <- brewer.pal(n=9, name="Set1")[c(1,2,9)]
 ...
 pdf(file = "/Users/mkerr/Documents/hospitalizations/4_24 flu hospitalizations.pdf", height = 24, width = 16)
